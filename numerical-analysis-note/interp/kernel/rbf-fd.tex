...
\section{RBF-FD 法}\label{sec:interp_kernel_rbf-fd}
...
\begin{equation}
    ...
    \label{eq:rbf_rbf-fd_approximation-formula}
\end{equation}
...
RBF-FD 法による近似の計算（式 \eqref{eq:rbf_rbf-fd_approximation-formula}）では不要である．
