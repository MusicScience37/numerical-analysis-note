...
\input{interp/kernel/derivation.tex}
\input{interp/kernel/rbf.tex}
\input{interp/kernel/additional-terms.tex}
\input{interp/kernel/reproducing-kernel.tex}
\input{interp/kernel/computation.tex}
\input{interp/kernel/optimization.tex}
\input{interp/kernel/operators.tex}
\input{interp/kernel/rbf-fd.tex}
