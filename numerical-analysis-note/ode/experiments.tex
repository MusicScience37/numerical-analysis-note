...
\begin{itemize}
    \item Runge-Kutta 法（\ref{chap:ode_runge-kutta} 章）
          \begin{itemize}
              ...
              \item 半陰的公式
                    \begin{description}
                        \item[ImplicitEuler] 陰的 Euler 法
                        \item[CrankNicolson] Crank-Nicolson 法
                        ...
                        \item[SDIRK6] SDIRK(9,6)[1]SAL-[(9,5)A] 公式 \cite{Alamri2023}
                        ...
                        \item[ESDIRK32a] ESDIRK 3/2 a 公式 \cite{Kvaerno2004}
              ...
              \item 陰的公式
                    \begin{description}
                        ...
                        \item[RadauIIA7] Radau IIA 7 次の公式 \cite{Hairer1991}
                        \item[RadauIIA9] Radau IIA 9 次の公式 \cite{Hairer1991}
                        \item[RadauIIA13] Radau IIA 13 次の公式 \cite{Hairer1991}
                        \item[RadauIIA17] Radau IIA 17 次の公式 \cite{Hairer1991}
                    \end{description}
          \end{itemize}
    \item Rosenbrock 法（\ref{sec:ode_rosenbrock} 章）
          \begin{description}
              \item[ROS3w] ROS3w 公式 \cite{Rang2005}
              \item[ROS3Dw] ROS3Dw 公式 \cite{Rang2005}
              \item[ROS3PRL2] ROS3PRL2 公式 \cite{Rang2015}
...
ここで，ステップ幅は \cite{Blom2013} に記載されているデジタルフィルタに基づくアルゴリズムにより自動で調整した．
...
ただし，計算量の多い陰的公式（Radau IIA など）も少し多めに時間がかかる程度であった．
陰的公式は 1 ステップの計算量が多くなるが，高い次数によりステップ数を削減できるため，
そのバランスにより性能が良くなっているものと思われる．
...
この微分代数方程式においても特に速かった公式は RODASP, RODASPR であった．
