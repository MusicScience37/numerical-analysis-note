...
\begin{equation}
    ...
    = -(I \otimes M) \bm{k} + \bm{f}\left(h ((T \Lambda T^{-1}) \otimes I) \bm{k}\right)
\end{equation}
となる．
...
\begin{equation}
    (h^{-1} \Lambda^{-1} \otimes M - I \otimes J) \Delta \bm{w}
    = (h^{-1} \Lambda^{-1} \otimes I)
    \left(-(I \otimes M) \bm{w} + (T^{-1} \otimes I) \bm{f}(h (T \Lambda \otimes I) \bm{w}) \right)
\end{equation}
となる．
