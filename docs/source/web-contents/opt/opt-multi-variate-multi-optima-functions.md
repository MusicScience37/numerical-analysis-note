...
show_plot_in_jupyter("opt-multi-variate-difficult-multi-optima-function-time", version=3)
```
...
show_plot_in_jupyter("opt-multi-variate-difficult-multi-optima-function-evaluations", version=3)
```
