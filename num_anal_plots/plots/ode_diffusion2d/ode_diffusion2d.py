...
def ode_diffusion2d_dirichlet_work_error() -> plotly.graph_objects.Figure:
    """ベンチマーク結果をプロットする。
    ...
    return px.line(
        ...
        log_x=True,
        log_y=True,
        title="Work-Error Diagram of ODE solvers for 2D Diffusion Equation (Dirichlet)",
    )


def ode_diffusion2d_neumann_work_error() -> plotly.graph_objects.Figure:
    """ベンチマーク結果をプロットする。
    ...
    return px.line(
        ...
        log_x=True,
        log_y=True,
        title="Work-Error Diagram of ODE solvers for 2D Diffusion Equation (Neumann)",
    )


def ode_diffusion2d_work_error() -> plotly.graph_objects.Figure:
    """ベンチマーク結果をプロットする。
