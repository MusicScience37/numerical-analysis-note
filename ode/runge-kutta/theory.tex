...
GMRES の代わりに使用できる．
例えば，
BiCGstab (Algorithm \ref{alg:ode_runge-kutta_bicgstab})
...
\begin{algorithm}[tp]
    ...
    \label{alg:ode_runge-kutta_bicgstab}
    \begin{algorithmic}
...
\begin{figure}[tp]
    ...
    \caption{BiCGstab（Algorithm \ref{alg:ode_runge-kutta_bicgstab}）を使用して%
        線形方程式を解くのにかかった時間}
